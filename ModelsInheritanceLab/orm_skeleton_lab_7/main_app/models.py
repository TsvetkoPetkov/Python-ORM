...
class ZooKeeper(Employee):
    ...
    def clean(self):
        ...
        choices = [choice[0] for choice in self.SPECIALIZATIONS]
...
class ZooDisplayAnimal(Animal):
    ...
    def display_info(self):
        return (f"Meet {self.name}! It's {self.species} and it's born {self.birth_date}. It makes a noise "
                f"like '{self.sound}'!{self.__extra_info()}")
